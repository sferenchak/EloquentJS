...
// using Array.prototype.some() by utilizing De Morgan's law:
// !(A && B) === !(!A || !B)
...
//can be "ltr" (left to right), "rtl" (right to left), or "ttb"
//(top to bottom).
...
function dominantDirection(text) {
	...
	return scripts.reduce((acc, curr) => (acc.count > curr.count ? acc : curr))
		.name;
}
